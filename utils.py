...
def prepare_parser():
  ...
  parser.add_argument(
    ...
    help='Save model every X iterations (default: %(default)s)')
  parser.add_argument(
    '--sample_every', type=int, default=2000,
    help='Sample images every X iterations (default: %(default)s)')
  parser.add_argument(
...
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder, 
             ...
             '128': dset.ImageFolder, '256': dset.ImageFolder, '512': dset.ImageFolder}
